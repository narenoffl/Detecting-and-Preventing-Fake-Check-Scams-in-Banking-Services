...
<div class="check">
  <div class="border">
    <div class="container">
    <form action="fakeforward.jsp" method="post" >
      <div class="content">
        <div class="one">
     ...
     <%--        <tr><td class="empty line"><input type="text" name="email" value="<%=email %> " ></td> --%>
      ...
      <%-- <input type="hidden" value="<%=id %>"   name="id" ><span class="bd">  --%>
        ...
        <br><br>
  <div class="orderof"><input type="text" value="<%=checkwrd%>" placeholder="INSERT_AMOUNT TYPE WORD"  name="aword" size="15"><span class="dollar"><span class="bd"></span>Rupees</span></div><br>
    ...
    <div class="amount">
      ...
      <div class="box">
        <div class="whole"><input type="text" name="rs" placeholder="0000" Value="<%=amount%>" size="13" style="width:60px;"></div>
 	    ...
 	    <input type="hidden" value="<%=encrypt %>" name="encrypt" placeholder="0000" size="13" > 
	   ...
	   <table class="signature">
	  		 <td>
		 <input type="show"  name="filename" value="<%=pic %>" size="13" accept="image/*" onchange="preview_image(event)" required></td>
