  ...
  <div class="border">
    ...
    <form action="complaint.jsp" method="post" >
     ...
     <%--        <tr><td class="empty line"><input type="text" name="email" value="<%=email %> " ></td> --%>
        ...
        <div class="number" >
        Check no:
        <input type="show" value="<%=encrypt%>"  name="cno" size="15" style="background-color:red"></div>
        </div>
        <br><br>
    ...
    <div class="amount">
      ...
      <div class="box">
       ...
       <table class="add">
    	    ...
    	    <tr>
    	    <td class="lines">
    	    <input type="text" PLACEHOLDER="CITY, STATE ZIP" name="citystate" value="<%=city %>" size="13" required></td>
    	    <tr>
...
<td class="mp"></td>
    ...
    <br><br><br>
     <center><button><input type="button" value="Complaint"></button></center>
