...
<br><br>
<form action="Fakecharservlet" method="post">
<div class="myDiv">
<center>
  <div class="container">
  <div class="font">
  ...
  <input type="password" class="fa fa-user" name="" placeholder="Password" style="width:280px;height:40px;text-align:center;" minlength="4" required><br><br>
